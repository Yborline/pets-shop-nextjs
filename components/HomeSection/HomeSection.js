    ...
    <Section>
      ...
      <DivText>
        ...
        <P>
          ...
          фізіологію, пропонуємо замовити індивідуальний розмір одягу, а також
          маємо додаткові опції на зміну фурнітури, виду та кольору тканини, щоб
          ...
          одягу. Ви можете обрати м'яку, теплу для холодних місяців або легку,
          дихаючу для літнього періоду. UA.Petshop працює з високоякісними
          матеріалами, щоб забезпечити омфорт та довговічність одягу тварини.
          <br />
